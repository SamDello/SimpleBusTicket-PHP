    ...
    <?php
        ...
        */
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No se encontraron buses!!</h1>
            ...
            <section id="bus">
                <div id="head">
                    <h4>estado de buses</h4>
                </div>
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Agregar detalles del autobús <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar un Autobús</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ¿Estás seguro de que deseas eliminar este autobús? <strong>Esta acción no tiene marcha atrás.</strong>
                </p>
                <!-- Needed to pass id -->
