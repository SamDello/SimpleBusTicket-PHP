            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">¡Sé la primera persona en añadir una!</p>
                        <hr>
                        <div id="addRouteAlert" class="alert alert-success" role="alert">
                                Haga clic en <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">
AGREGAR <i class="fas fa-plus"></i></button> para agregar una ruta!
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <section id="route">
                    <div id="head">
                        <h4>Estado de la ruta</h4>
                    </div>
                    <div id="route-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Agregar detalles de ruta <i class="fas fa-plus"></i></button>
                        </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">Vía Ciudades</label>
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">Número de autobús</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">Hora de salida</label>
                            ...
                            <button type="submit" class="btn btn-success" name="submit">Entregar</button>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ¿Realmente desea eliminar esta ruta?<strong>
Este proceso no se puede deshacer</strong>
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button type="submit" form="delete-form" name="delete" class="btn btn-danger">Borrar</button>
            </div>
            </div>
        </div>
        </div>
