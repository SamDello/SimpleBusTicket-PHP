...
<?php
        ...
        */
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">"¡No se encontraron reservas!"</h1>
                        <p class="fw-light">Sé el primero en agregar una!</p>
                        <hr>
            ...
            <section id="booking">
                <div id="head">
                    <h4>Estado de reservacion</h4>
                </div>
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Añadir reservas<i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Realizar Reservas</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">ID Cliente</label>
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">Cliente</label>
                            ...
                            <div class="mb-3">
                                <label for="routeSearch" class="form-label">RUTAS</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">Numero de asiento</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    Selecciona del diagrama anterior, un máximo de 1 asiento.
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">Monto Total</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ¿Estas seguro de que quieres eliminar esta reserva? <strong>Esta accion no tiene marcha atras.</strong>
                </p>
                <!-- Needed to pass id -->
