            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./booking.php">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./bus.php">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="./route.php">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <a href="./seat.php">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <a href="./customer.php">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Admin" class="info-box user-item">
                        ...
                        <a href="#admin">Ver Más <i class="fas fa-arrow-right"></i></a>
                    </div>
                    ...
                    <?php 
                        ...
                        ?>
                            <div class="info-box admin-item">
                                ...
                                <p class="bio">Otro Administrador</p>
                            </div>
                        <?php 
                        }
                    ?>
                ...
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Sistema de Reserva de Boletos Trans. El Dorado
                        </p>
                </footer>
        </div>
    </main>
